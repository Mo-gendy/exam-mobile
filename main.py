...
def main(page: ft.Page):
    ...
    try:
        ...
        page.add(startup_view)
        page.update() # Explicitly update the page after adding views

    except Exception as e:
        page.clean()
        page.add(
            ft.Text("Critical Startup Error", size=30, color="red"),
            ft.Text(str(e), color="red"),
            ft.Text(f"Type: {type(e).__name__}", color="red")
        )
        page.update()
